...
<div class="container mt-3">
    <div class="card">
        <div class="card-header">
            ...
            <h3 class="card-title">Plantation Right Side Add</h3>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.plantationright.store') }}" method="post" enctype="multipart/form-data">
