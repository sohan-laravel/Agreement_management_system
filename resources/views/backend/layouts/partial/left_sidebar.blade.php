        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('admin.plantation.index') }}" class="nav-link {{ Route::is('admin.plantation.index') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Plantation Left</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('admin.plantationright.index') }}" class="nav-link {{ Route::is('admin.plantationright.index') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Plantation Right</p>
                </a>
              </li>
